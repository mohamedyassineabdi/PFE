    ...
    <span
      className={twMerge(
        clsx(
          ...
          children && show && !width && !height && "relative after:absolute after:bottom-0 after:left-0 after:right-0 after:top-0 after:rounded after:bg-skeleton-gradient after:bg-[length:400%_100%]",
